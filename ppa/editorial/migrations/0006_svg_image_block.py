...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='authors',
            field=wagtail.core.fields.StreamField([('author', wagtail.snippets.blocks.SnippetChooserBlock(ppa.pages.models.Person))], blank=True, help_text='Select or create people snippets to add as authors.'),
        ),
        migrations.AlterField(
            model_name='editorialpage',
            name='body',
